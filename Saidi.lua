...
{
{text = '𓄼• 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙿𝚃𝙷𝙾𝙽 •𓄹', url='https://t.me/Tepthon'},
},
}
}
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼• 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙿𝚃𝙷𝙾𝙽 •𓄹', url = "http://t.me/Tepthon"}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
data = {
{
{text = '𓄼• 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙿𝚃𝙷𝙾𝙽 •𓄹', url = 't.me/Tepthon'}, 
},
}
}
...
{
{text = '𓄼• 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙿𝚃𝙷𝙾𝙽 •𓄹', url = "http://t.me/Tepthon"}
},
}
local msg_id = msg.id/2097152/0.5
...
local Mostafa = (Redis:get(Saidi.."Name:Bot") or "تيبثون")
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
local RinkBot = msg.Name_Controller
photo = "http://t.me/Tepthon"
local Name = '*𓄼• ᴡᴇʟᴄᴏᴍᴇ ʏᴀ->* ['..RinkBot..'](tg://user?id='..user_info.id..')\n*𓄼• ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙿𝚃𝙷𝙾𝙽*\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• Dev mohammad 𓄹', url = "https://t.me/P17_12"}
},
{
{text = '𓄼•  𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙿𝚃𝙷𝙾𝙽•𓄹', url = "http://t.me/Tepthon"}
},
...
local Name = '*المطور محمد هو مطور السورس لو حابب تتواصل معاه*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• Dev mohammad•𓄹', url = "https://t.me/JABWA"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))

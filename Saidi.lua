...
ControllerAll = false
local ListSudos ={Sudo_Id,1260465030,1038368606,1184518615}  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/Tepthon'}, },}}
...
NamesBot = (Redis:get(COCAINE.."COCAINE:Name:Bot") or "تيبثون")
...
{
{text = Jabwa, url = 't.me/Tepthon'}, 
},
{
{text = Grosupsw, url = 't.me/Tepthon'}, 
},
{
{text = Usperos, url = 't.me/Tepthon'}, 
},
}
...
data = {
{
{text = '˹  𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐄𝐁𝐓𝐇𝐎𝐍 . ❈', url = 't.me/Tepthon'}, 
},
}
}
...
keyboard.inline_keyboard = {
{
{text = 'قناه السورس ', url = "https://t.me/Tepthon"}
},
}
local msgg = msg_id/2097152/0.5
...
local m = "https://t.me/Tepthon/"..Rrr..""
...
local T =[[
⦑ W𝙀𝙇𝘾𝙊𝙈𝙀 T𝙊 𝐓𝐄𝐏𝐓𝐇𝐎𝐍 𝐒𝐎𝐔𝐑𝐂𝐄♥️⦒
★┉ ┉ ┉ ┉ ┉ TEP ┉  ┉ ┉ ┉ ┉★
➥┇𝚆
W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚃𝙷𝙴 𝚃𝙴𝙿𝚃𝙷𝙾𝙽 𝚂𝙾𝚄𝚁𝙲𝙴
...
keyboard.inline_keyboard = {
{
{text = '˹ 𝓶𝓸𝓱𝓪𝓶𝓶𝓪𝓭  ⁦. 𓌗', url = "https://t.me/P17_12"},{text = '˹  𝓶𝓸𝓱𝓪𝓶𝓶𝓪𝓭 ⁦. ❈', url = "https://t.me/P17_12"}
},
{
{text = '˹𝓶𝓸𝓱𝓪𝓶𝓶𝓪𝓭   ⁦. 𓌗', url = "https://t.me/P17_12"},{text = '˹  𝓶𝓸𝓱𝓪𝓶𝓶𝓪𝓭 ⁦. ❈', url = "https://t.me/Tepthon"}
},
{
{text = '˹  𝐓𝐄𝐏𝐓𝐇𝐎𝐍  . ❈', url = "https://t.me/Tepthon"}
},
}
local msgg = msg_id/2097152/0.5
...
if text == 'محمد' or text == 'jok' or text == 'JOK' then
photo = "https://t.me/P17_12"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ mohammad \n ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '.َ ‹Dev mohammad, url = "https://t.me/JOKN1"}
},
}
local msgg = msg_id/2097152/0.5
...
local NamesBot = (Redis:get(COCAINE.."COCAINE:Name:Bot") or "تيبثون")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/Tepthon'}, 
},
{
...
if text == (Redis:get(COCAINE.."COCAINE:Name:Bot") or "تيبثون") then
local photo = LuaTele.getUserProfilePhotos(COCAINE)
local ban = LuaTele.getUser(COCAINE)
for Name_User in string.gmatch(ban.first_name, "[^%s]+" ) do
ban.first_name = Name_User
...
local CmdStart = '*\n ⦁ أهلآ بك في بوت '..(Redis:get(COCAINE.."COCAINE:Name:Bot") or "تيبثون")..
